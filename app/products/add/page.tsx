...
=======
                ...
                {/* 🛑 NEW: Expiry Date Field (Insert this into the grid) */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    <span className="flex items-center space-x-1">
                      {/* Using a simple calendar icon */}
                  ...
                  <input
                    type="date"
                    name="expiryDate"
                    value={formData.expiryDate} // Binds to the new state field
                    onChange={handleChange}     // Uses your existing change handler
                    className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 bg-white dark:bg-gray-700 text-gray-900 dark:text-white hover:border-gray-400 dark:hover:border-gray-500"
                  />
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Optional. Leave blank if product does not expire.</p>
                </div>
                {/* 🛑 END NEW: Expiry Date Field */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    <span className="flex items-center space-x-1">
                      <Hash className="w-4 h-4" />
